// Lucide-style icon sprite for non-React/server-rendered HTML surfaces
// (registration backend templates, exported mockups). Inject once per
// page via <script src="icons-html.js"></script>; consume via:
//   <svg class="i" width="14" height="14"><use href="#i-pause"/></svg>
//
// The React equivalent lives in icon-sprite.tsx and renders identical
// symbols — keep both in lockstep.
(function () {
